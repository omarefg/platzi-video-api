...
class MovieService {
    ...
    async updateOrCreateMovie ({ movieId, movie } = {}) {
        const updatedOrCreatedMovieId = await this.mongoDB.update(this.collection, movieId, movie)
        return updatedOrCreatedMovieId || {}
    }
